...
public function obtener_clientes() {
    $arrRespuesta = array();
    $sql = "SELECT id, dni, nombre, apellido, telefono, correo,`fecha_registro`,
                   CASE 
    ...
    public function registrarCliente($dni, $nombre, $apellido, $telefono, $correo, $estado) {
        $sql = "INSERT INTO `cliente_api` 
                (dni, nombre, apellido, telefono, correo, `fecha_registro`, estado) 
                VALUES (?, ?, ?, ?, ?, NOW(), ?)";
    ...
    $sql = "SELECT id, nombre, apellido FROM `cliente_api` ORDER BY nombre ASC";
